...
model = dict(
    type='CQ_RetinaNet',
    pre_encoder = dict(type='CQ_DENet'),
    backbone=dict(
        type='ResNeXt',
        depth=101,
        groups=32,
...
train_dataloader = dict(dataset=dict(data_prefix=dict(img='image_pairLIE')))
val_dataloader = dict(dataset=dict(data_prefix=dict(img='image_pairLIE')))
